...
/** The API_placeOrder path router defined in './routes/API_placeOrder'. */
const API_placeOrderRouter = require('./routes/API_placeOrder.router')
...
app.use('/api/placeOrder', API_placeOrderRouter);
