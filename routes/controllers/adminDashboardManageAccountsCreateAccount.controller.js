 ...
 * @fileoverview adminDashboardManageAccountsCreateAccountPage route's controller.
 *    Exports functions to be used by each route handler.
 * @exports {Object} Functions to attach to the
 *    `adminDashboardManageAccountsCreateAccountPage` router.
    ...
    .then(res_cookie => {
      ...
      // if not admin cookie send to userdashboard
        ...
        if (res_cookie["isAdmin"] == 1) {
          res.render('admin_dashboard-manage_accounts-create_account_page', {
            title: 'Sprout Creek Farm Admin Dashboard | Create Accounts',
            page: 'login',
