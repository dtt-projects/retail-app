/**
 * @module routes/controllers/adminDashboardManageAccountsSubInventoryPage
 * @fileoverview adminDashboardManageAccountsSubInventoryPage route's controller.
...
/**
 * @function sendAdminDashboardManageAccountsSubInventoryPage
 ...
 */
const sendAdminDashboardManageAccountsSubInventoryPage = (req, res, next) => {
    ...
    .then(res_cookie => {
      ...
      // if not admin cookie send to userdashboard
        ...
        if (res_cookie["isAdmin"] == 1) {
          res.render('admin_dashboard-manage_accounts-sub_inventory_page', {
...
module.exports = {
  sendAdminDashboardManageAccountsSubInventoryPage,
};
