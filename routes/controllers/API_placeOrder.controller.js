/**
 * @module routes/controllers/API_placeOrder
 * @fileoverview API_placeOrder route's controller. Handle all business logic
 * relative to API_placeOrder for the users.
 * @exports {Object} Functions to attach to the `API_placeOrder` router.
 * @require read-hidden
...
/**
 * @function placeOrder
 * @description place Order in ibm db
