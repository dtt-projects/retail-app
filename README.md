...
5. General code contribution best practices.
...
**NOTE**: if you run this server in production mode, it will spawn a Node.js process in the background. You'll need the following command to kill this process from the terminal:
